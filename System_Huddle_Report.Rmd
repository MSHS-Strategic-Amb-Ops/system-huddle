...
# rad_onc_data_raw <- as.data.frame(read.csv(file.choose()))
# radiology_data_raw <- as.data.frame(read.csv(file.choose()))
# radiology_ref <- as.data.frame(read.csv(file.choose()))
