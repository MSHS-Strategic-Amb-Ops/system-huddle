...
hh_data_comp_raw <-  as.data.frame(read_csv("hh_comp.csv"))
# hh_data_msd_raw <-  as.data.frame(read_csv("hh_msd.csv"))
hh_crosswalk <- as.data.frame(read_csv("hh_crosswalk.csv"))
...
missing_exc_dept <- read_excel("open_encounters_exclusion.xlsx", sheet = "Department")
missing_exc_resource <- read_excel("open_encounters_exclusion.xlsx", sheet = "Resource")
missing_exc_visitType <- read_excel("open_encounters_exclusion.xlsx", sheet = "Visit Type")
...
hh_site <- bind_rows(hh_site, network)
hh_site <- hh_site %>%
  arrange(site, Month)
