...
# scheduling_data_raw <- as.data.frame(readRDS("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/historical_data.rds")) %>%
#   filter(!is.na(Campus)) %>%
#    filter(Campus %in% c("NETWORK","MSM","MSH-MSDFP","ONCOLOGY","MSW","MSBI","MSUS","MSH- AMBULATORY CARE","MSDD")) 
...
# hh_data_comp_raw <-  as.data.frame(read_csv("C:/Users/kweons01/Desktop/Strategic Initiatives - So Youn/Github/server-upload/hh_comp.csv"))
