...
# conn1 <- odbcConnect("handhygiene") # Connect to Server
# 
# # Import Referrals+Visit Data --------------------------------------------------
# hh_data_comp_raw <- sqlQuery(conn1, "SELECT * FROM qidm_dev.dbo.amb_hand_hygiene_comp") # Master Referrals Data
...
#                     Port = 1433)     
# 
# hh_data_comp_raw <- sqlQuery(con_hh, "SELECT * FROM qidm_dev.dbo.amb_hand_hygiene_comp")
